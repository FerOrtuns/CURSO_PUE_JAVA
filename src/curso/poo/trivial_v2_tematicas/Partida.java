...
public class Partida {
    ...
    private static void ordenarPreguntasPorDificultadFuncional() {
        ...
        List<Pregunta> preguntasOrdenadasPorDificultad = rangeClosed(0, dificultadMaxima).boxed().flatMap(dificultad -> preguntas.stream().filter(p -> p.getDificultad() == dificultad)).toList();
